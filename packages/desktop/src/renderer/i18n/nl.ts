export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Lunos is gedownload. Wil je deze installeren en Lunos opnieuw starten?",
