export const dict = {
  ...
  "desktop.updater.none.message": "Már az Lunos legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Lunos {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
