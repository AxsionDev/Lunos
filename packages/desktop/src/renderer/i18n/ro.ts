export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Lunos a fost descărcată. Vrei să o instalezi și să repornești?",
