export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Lunos uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Lunos'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
