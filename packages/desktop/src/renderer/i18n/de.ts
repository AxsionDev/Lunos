export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Lunos wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
