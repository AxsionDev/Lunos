export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Lunos er lastet ned. Vil du installere den og starte på nytt?",
