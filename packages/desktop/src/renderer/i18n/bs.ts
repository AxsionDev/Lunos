export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Lunos-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Lunos-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
