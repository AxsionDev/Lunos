export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Lunos është shkarkuar, dëshironi ta instaloni dhe rinisni?",
