export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Lunos har laddats ned. Vill du installera den och starta om programmet?",
