export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Lunos-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Lunos-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
