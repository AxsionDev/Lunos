export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Lunos versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Lunos versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
