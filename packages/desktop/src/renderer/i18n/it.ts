export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Lunos è stata scaricata. Vuoi installarla e riavviare l'app?",
