export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Lunos er blevet downloadet. Vil du installere den og genstarte?",
