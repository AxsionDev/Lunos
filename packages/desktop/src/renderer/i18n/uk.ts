export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію Lunos",
  ...
  "desktop.updater.downloaded.prompt": "Версію {{version}} Lunos завантажено. Бажаєте встановити її та перезапустити?",
