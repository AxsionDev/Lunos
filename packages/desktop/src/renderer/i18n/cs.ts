export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Lunos. Chcete ji nainstalovat a aplikaci znovu spustit?",
