export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Lunos versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
