export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Lunos. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
