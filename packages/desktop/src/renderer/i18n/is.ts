export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af Lunos hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
