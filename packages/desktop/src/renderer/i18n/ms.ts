export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Lunos telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
