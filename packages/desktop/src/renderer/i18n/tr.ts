export const dict = {
  ...
  "desktop.updater.none.message": "Lunos'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Lunos'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
