export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent de Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} de Lunos. Voleu instal·lar-la i reiniciar l'aplicació?",
