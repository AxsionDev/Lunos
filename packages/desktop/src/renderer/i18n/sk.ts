export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Lunos",
  ...
  "desktop.updater.downloaded.prompt": "Verzia {{version}} Lunos bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
