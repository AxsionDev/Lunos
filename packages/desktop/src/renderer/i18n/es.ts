export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Lunos",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Lunos. ¿Quieres instalarla y reiniciar?",
