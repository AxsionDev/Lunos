export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Lunos",
  ...
  "desktop.recovery.loadFailed": "Lunos gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Lunos ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Lunos tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Lunos gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Lunos selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Lunos.",
  ...
  "dialog.server.description": "Tukar pelayan Lunos yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Lunos dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Lunos dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Lunos dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Lunos dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Lunos boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Lunos tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Lunos ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Lunos",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Lunos belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Lunos dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Lunos",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Lunos pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Lunos mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Lunos.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Lunos dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Lunos.",
