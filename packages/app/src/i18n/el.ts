export const dict = {
  ...
  "desktop.menu.documentation": "Lunos Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Lunos μενού",
  ...
  "desktop.recovery.loadFailed": "Lunos απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Lunos το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Lunos δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "Lunos η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Lunos η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Lunos.",
  ...
  "provider.connect.opencodeZen.line1":
    "Lunos Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Lunos.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Lunos συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.step.opencode": "Lunos",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος Lunos σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση Lunos σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση Lunos σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του Lunos στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Lunos να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Lunos δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Lunos.",
  ...
  "help.tabs.introduction": "Lunos Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Lunos ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Lunos",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Lunos δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Lunos Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Lunos μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Lunos",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Lunos στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Lunos ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Lunos.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Lunos",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Lunos.",
