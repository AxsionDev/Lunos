export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Lunos.",
  ...
  "dialog.server.description": "Cambia il server Lunos a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Lunos in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Lunos in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Lunos in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Lunos in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Lunos possa aggiungere un server WSL",
  ...
  "help.tabs.introduction": "Lunos Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Lunos ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Lunos",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Lunos non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Lunos all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Lunos",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Lunos sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Lunos segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Lunos.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Lunos",
  ...
  "settings.updates.toast.latest.title": "Lunos è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Lunos.",
  ...
  "desktop.menu.documentation": "Documentazione di Lunos",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Lunos",
  "desktop.recovery.terminated": "La finestra di Lunos si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Lunos non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Lunos non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Lunos è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
