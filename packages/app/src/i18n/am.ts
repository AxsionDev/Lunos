export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunos መጫን አልቻለም",
  "desktop.recovery.terminated": "Lunos መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Lunos ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Lunosመጫኑ አልተሳካም",
  ...
  "provider.connect.opencodeZen.line1": "Lunos ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በLunos ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Lunos አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Lunosን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Lunos በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Lunos በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Lunos ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Lunos በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunosአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Lunos WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Lunos በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Lunos።",
  ...
  "help.tabs.introduction": "Lunos ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የLunos ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለLunos ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Lunos እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Lunos ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የLunos አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለLunos",
  ...
  "settings.general.row.appearance.description": "Lunosበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Lunos ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Lunos ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Lunos ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የLunos እትም እያሄዱ ነው።",
