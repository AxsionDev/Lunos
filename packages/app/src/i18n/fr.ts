export const dict = {
  ...
  "toast.update.description":
    "Une nouvelle version d'Lunos ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "Lunos inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
