export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Lunos",
  ...
  "desktop.menu.ariaLabel": "Menu Lunos",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Lunos",
  "desktop.recovery.terminated": "La fenêtre Lunos s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Lunos ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Lunos",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Lunos est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Lunos.",
  ...
  "dialog.server.description": "Changez le serveur Lunos auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Lunos dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Lunos dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Lunos dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Lunos dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Lunos puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Lunos n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Une nouvelle version d'Lunos ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Lunos",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Lunos ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Lunos inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Lunos dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Lunos",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Lunos sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Lunos suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Lunos.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Lunos",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Lunos.",
