export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Lunos",
  ...
  "desktop.menu.ariaLabel": "Lunos meni",
  ...
  "desktop.recovery.loadFailed": "Lunos se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Lunos-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Lunos ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Lunos-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Lunos-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Lunos-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Lunos-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Lunos-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Lunos server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Lunos u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Lunos u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Lunos u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Lunos u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Lunos mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Lunos nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Lunos-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Lunos timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Lunos još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Lunos uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Lunos server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Lunos-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Lunos izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Lunos prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Lunos-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Lunos pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Lunos-a.",
