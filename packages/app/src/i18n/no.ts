...
export const dict = {
  ...
  "desktop.menu.documentation": "Lunos-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Lunos-meny",
  ...
  "desktop.recovery.loadFailed": "Lunos kunne ikke lastes inn",
  "desktop.recovery.terminated": "Lunos-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Lunos svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Lunos mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Lunos er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Lunos.",
  ...
  "dialog.server.description": "Bytt hvilken Lunos-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Lunos ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Lunos-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Lunos ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Lunos inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Lunos-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Lunos",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Lunos ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Lunos skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Lunos.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Lunos starter",
  ...
  "settings.updates.toast.latest.title": "Lunos er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Lunos.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Lunos i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Lunos i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Lunos i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Lunos i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Lunos kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Lunos kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Lunos på nytt.",
  ...
  "help.tabs.introduction": "Lunos Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
