export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Lunos.",
  ...
  "dialog.server.description": "Skift hvilken Lunos-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Lunos i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Lunos i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Lunos i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Lunos kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Lunos kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Lunos igen.",
  ...
  "toast.update.description": "En ny version af Lunos ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Lunos-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Lunos understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Lunos inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Lunos-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Lunos",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Lunos ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Lunos skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Lunoss tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Lunos starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Lunos.",
  ...
  "desktop.recovery.loadFailed": "Lunos kunne ikke indlæses",
  "desktop.recovery.terminated": "Lunos-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Lunos mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Lunos er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Lunos Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
