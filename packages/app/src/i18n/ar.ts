export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Lunos",
  "desktop.recovery.terminated": "توقفت نافذة Lunos بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Lunos لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Lunos",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Lunos، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Lunos.",
  ...
  "dialog.server.description": "تبديل خادم Lunos الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Lunos في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Lunos في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Lunos في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Lunos في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Lunos من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Lunos التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Lunos.",
  ...
  "help.tabs.introduction": "أصبح Lunos Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Lunos ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Lunos",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Lunos لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Lunos نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Lunos داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Lunos",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Lunos على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Lunos يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Lunos.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Lunos",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Lunos.",
