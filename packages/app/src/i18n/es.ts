export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Lunos",
  ...
  "desktop.menu.ariaLabel": "Menú de Lunos",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Lunos",
  "desktop.recovery.terminated": "La ventana de Lunos se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Lunos no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Lunos",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Lunos finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Lunos.",
  ...
  "dialog.server.description": "Cambiar el servidor de Lunos al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Lunos en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Lunos en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Lunos en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Lunos en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Lunos pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Lunos no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Lunos ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Lunos",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Lunos aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Lunos dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Lunos",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Lunos en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Lunos sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Lunos.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Lunos",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Lunos.",
