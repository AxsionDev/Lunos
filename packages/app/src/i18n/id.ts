export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunos gagal dimuat",
  "desktop.recovery.terminated": "Jendela Lunos berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Lunos tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Lunos gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Lunos selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Lunos.",
  ...
  "dialog.server.description": "Ganti server Lunos mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Lunos di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Lunos di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Lunos di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Lunos di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Lunos dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Lunos tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Lunos ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Lunos",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Lunos belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Lunos di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Lunos",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Lunos di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Lunos mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Lunos diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Lunos.",
