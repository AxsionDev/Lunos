export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunos yüklənə bilmədi",
  "desktop.recovery.terminated": "Lunos pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Lunos cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Lunos quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Lunos yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Lunos-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Lunos-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Lunos-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Lunos serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Lunos yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Lunos yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Lunos yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Lunos yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Lunos-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Lunos-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Lunos {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Lunos hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Lunos-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Lunos quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Lunos WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Lunos bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Lunos-u yenidən açın.",
  ...
  "help.tabs.introduction": "Lunos Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Lunos-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Lunos komandasına",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" uğursuz oldu. Qeyd: Lunos hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Lunos-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Lunos serverini işlət.",
  ...
  "settings.general.row.language.description": "Lunos üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Lunos-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description": "Lunos-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Lunos-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Lunos açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Lunos-un ən son versiyasından istifadə edirsiniz.",
