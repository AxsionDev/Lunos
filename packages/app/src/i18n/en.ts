...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Lunos.",
  ...
  "dialog.server.description": "Switch which Lunos server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Lunos in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Lunos in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Lunos in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Lunos in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Lunos can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Lunos could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Lunos ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Lunos team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Lunos does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Lunos includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Lunos server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Lunos",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Lunos looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Lunos follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Lunos is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Lunos launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Lunos.",
