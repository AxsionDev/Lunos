export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Lunosssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Lunosssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Lunosssa.",
  ...
  "dialog.server.description": "Vaihda Lunos-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Lunosa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Lunosa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Lunosa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Lunosa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Lunos jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Lunos jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunosa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Lunos voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Lunos ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Lunos uudelleen.",
  ...
  "toast.update.description": "Lunosn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Lunos-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Lunos ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Lunos sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Lunos-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Lunosn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Lunos näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Lunos järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Lunosn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Lunos käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Lunosn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Lunos-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Lunos-valikko",
  ...
  "desktop.recovery.loadFailed": "Lunosn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Lunos-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Lunos ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Lunosn asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunosa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Lunosn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Lunos Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
