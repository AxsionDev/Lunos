export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunos kunde inte läsas in",
  "desktop.recovery.terminated": "Lunos-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Lunos svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Lunos misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Lunos-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Lunos.",
  ...
  "dialog.server.description": "Växla vilken Lunos-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Lunos i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Lunos i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Lunos i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Lunos i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Lunos kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Lunos kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Lunos igen.",
  ...
  "help.tabs.introduction": "Lunos Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Lunos ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Lunos-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Lunos stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Lunos innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Lunos-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Lunos",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Lunos ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Lunos följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Lunoss tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Lunos startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Lunos.",
