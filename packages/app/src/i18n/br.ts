export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Lunos",
  ...
  "desktop.menu.ariaLabel": "Menu do Lunos",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Lunos",
  "desktop.recovery.terminated": "A janela do Lunos foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Lunos não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Lunos",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Lunos não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Lunos foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Lunos.",
  ...
  "dialog.server.description": "Trocar para qual servidor Lunos este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Lunos em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Lunos em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Lunos em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Lunos",
  "wsl.onboarding.opencodeReadyIn": "O Lunos está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Lunos está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Lunos em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Lunos possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Lunos não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Lunos novamente.",
  ...
  "help.tabs.introduction": "Agora, o Lunos Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Lunos ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Lunos",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Lunos ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Lunos dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Lunos",
  ...
  "settings.general.row.appearance.description": "Personalize como o Lunos aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Lunos segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Lunos é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Lunos iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Lunos.",
