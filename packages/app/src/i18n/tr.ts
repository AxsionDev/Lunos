...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunos yüklenemedi",
  "desktop.recovery.terminated": "Lunos penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Lunos yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Lunos kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Lunos güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Lunos'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Lunos'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Lunos'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Lunos sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Lunos kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Lunos kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Lunos güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Lunos güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Lunos'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Lunos'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Lunos hazır.",
  "wsl.onboarding.opencodeReady": "Lunos hazır.",
  "wsl.onboarding.installOpencodeIn": "Lunos'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Lunos'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Lunos'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Lunos bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Lunos'u tekrar açın.",
  ...
  "help.tabs.introduction": "Lunos Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Lunos'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Lunos ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Lunos henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Lunos ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Lunos Masaüstü",
  ...
  "settings.desktop.wsl.description": "Lunos sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Lunos'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Lunos'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Lunos'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Lunos'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Lunos başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Lunos'un en son sürümünü kullanıyorsunuz.",
