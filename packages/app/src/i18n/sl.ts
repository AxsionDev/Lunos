export const dict = {
  ...
  "desktop.menu.documentation": "Lunos Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Lunos ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Lunos se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Lunos se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Lunos ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Lunos je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Lunos.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Lunos se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Lunos ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Lunos v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Lunos ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Lunos v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Lunos v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Lunos v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Lunos doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Lunos ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Lunos ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Lunos",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Lunos še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Lunos vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Lunos znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Lunos",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Lunos izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Lunos sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Lunos.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Lunos",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Lunos.",
