...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Lunos se nije uspio učitati",
  "Prozor aplikacije Lunos neočekivano je zatvoren",
  "Lunos ne reagira",
  ...
  "Instalacija aplikacije Lunos nije uspjela",
  ...
  "Lunos nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Lunos je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Lunos.",
  ...
  "dialog.server.description": "Promijenite na koji se Lunos poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Lunos u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Lunos u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Lunos u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Lunos u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Lunos",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Lunos može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Lunos nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Lunos.",
  ...
  "help.tabs.introduction": "Radna površina Lunos sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Lunos ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Lunos timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Lunos još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Lunos uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Lunos Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Lunos poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Lunos",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Lunos izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Lunos slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Lunos tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Lunos pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Lunos.",
