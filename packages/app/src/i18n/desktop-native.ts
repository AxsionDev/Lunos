...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Lunos failed to load",
  "desktop.recovery.terminated": "Lunos window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Lunos is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Lunos installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Lunos update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
