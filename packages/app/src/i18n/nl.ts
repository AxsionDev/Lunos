export const dict = {
  ...
  "desktop.menu.documentation": "Lunos-documentatie",
  ...
  "desktop.recovery.loadFailed": "Lunos kan niet worden geladen",
  "desktop.recovery.terminated": "Het Lunos-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Lunos reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Lunos is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Lunos-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Lunos te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Lunos te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Lunos te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Lunos-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Lunos controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Lunos controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Lunos bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Lunos bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Lunos bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Lunos bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Lunos is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Lunos in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Lunos een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Lunos kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Lunos opnieuw.",
  ...
  "help.tabs.introduction": "Lunos Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Lunos ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Lunos-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Lunos ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Lunos bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Lunos-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Lunos",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Lunos eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Lunos het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Lunos aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Lunos wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Lunos is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Lunos.",
