export const dict = {
  ...
  "desktop.menu.documentation": "Lunos hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Lunos menyusi",
  ...
  "desktop.recovery.loadFailed": "Lunos yuklanmadi",
  "desktop.recovery.terminated": "Lunos oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Lunos javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Lunos oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Lunos yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Lunos’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Lunos da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Lunos da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Lunos serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Lunos tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Lunos {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Lunos yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Lunos {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Lunos-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Lunos-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Lunos {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Lunos tayyor.",
  "wsl.onboarding.installOpencodeIn": "Lunos-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Lunos-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Lunos WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Lunos WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Lunos-ni qayta oching.",
  ...
  "help.tabs.introduction": "Lunos Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Lunos ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Lunos jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Lunos hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Lunos bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Lunos serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Lunos uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Lunos qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Lunos tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Lunos mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Lunos ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Lunos oxirgi versiyasini ishga tushiryapsiz.",
