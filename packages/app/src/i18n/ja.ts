export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunosを読み込めませんでした",
  "desktop.recovery.terminated": "Lunosのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Lunosが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Lunosのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはLunosがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Lunosのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Lunosで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してLunosで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Lunosで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するLunosサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Lunosを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のLunosを確認中...",
  "wsl.onboarding.updatingOpencode": "Lunosを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のLunosを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のLunosを更新してください。",
  "wsl.onboarding.updateOpencode": "Lunosを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のLunosの準備ができました。",
  "wsl.onboarding.opencodeReady": "Lunosの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にLunosをインストールしてください。",
  "wsl.onboarding.installOpencode": "Lunosをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunosがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "LunosでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Lunosをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Lunos Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Lunosの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをLunosチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: LunosはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Lunosには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でLunosサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Lunosの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのLunosの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Lunosがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Lunosのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Lunos の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Lunos は最新バージョンです。",
