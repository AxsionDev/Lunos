export const dict = {
  ...
  "desktop.recovery.loadFailed": "Lunos laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Lunos aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Lunos ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Lunos installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Lunos värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Lunos'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Lunos.",
  ...
  "dialog.server.description": "Lülitage, millise Lunos serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Lunos kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Lunos kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Lunos värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Lunos värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Lunos jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Lunos asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Lunos saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Lunos ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Lunos.",
  ...
  "help.tabs.introduction": "Lunos Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Lunos ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Lunos meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Lunos ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Lunos sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Lunos Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Lunos server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Lunos kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Lunos teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Lunos järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Lunos on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Lunos käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Lunos uusimat versiooni.",
