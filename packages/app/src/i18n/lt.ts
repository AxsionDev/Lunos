...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Lunos įkelti nepavyko",
  "Lunos langas netikėtai užsidarė",
  "Lunos neatsako",
  ...
  "Lunos įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Lunos neįdiegtas distributyve {{distro}}",
  "Lunos naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Lunos.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Lunos serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Lunos {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Lunos {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Lunos {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Lunos į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Lunos galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Lunos nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Lunos ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Lunos komandai",
  ...
  "sidebar.gettingStarted.line1": "Lunos apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Lunos darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Lunos serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Lunos ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Lunos atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Lunos seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Lunos temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Lunos",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Lunos versiją.",
