...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Lunos zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Lunos zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Lunos zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Lunos-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Lunos wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Lunos in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Lunos wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Lunos in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Lunos in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Lunos aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Lunos ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Lunos ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Lunos in {{distro}}.",
  "wsl.onboarding.installOpencode": "Lunos installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Lunos einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Lunos konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Lunos erneut.",
  ...
  "toast.update.description": "Eine neue Version von Lunos ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Lunos-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Lunos unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Lunos mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Lunos enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Lunos-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Lunos ändern",
  ...
  "settings.updates.row.startup.description": "Beim Start von Lunos automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Lunos ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Lunos wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Lunos konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Lunos-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Lunos reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Lunos-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Lunos-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Lunos Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
