export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Lunos",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Lunos",
  "desktop.recovery.terminated": "Okno Lunos zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Lunos nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Lunos",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Lunos nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Lunos została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Lunos.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Lunos.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Lunos.",
  ...
  "dialog.server.description": "Przełącz serwer Lunos, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Lunos...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Lunos w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Lunos...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Lunos w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Lunos w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Lunos",
  "wsl.onboarding.opencodeReadyIn": "Lunos jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Lunos jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Lunos w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Lunos",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Lunos nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Lunos będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Lunos nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Lunos.",
  ...
  "help.tabs.introduction": "Lunos Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Lunos ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Lunos",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Lunos nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Lunos zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Lunos wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Lunos",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Lunos na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Lunos ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Lunos.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Lunos",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Lunos.",
