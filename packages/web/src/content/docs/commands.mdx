...
You can add custom commands through the Lunos config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Lunos [config](/docs/config):
