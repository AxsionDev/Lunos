---
title: LSP Servers
description: Lunos integrates with your LSP servers.
---

Lunos can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Lunos comes with several built-in LSP servers for popular languages:
