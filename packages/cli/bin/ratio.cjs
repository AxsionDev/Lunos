...
const cached = path.join(scriptDir, ".ratio")
const platform = { darwin: "darwin", linux: "linux", win32: "windows" }[os.platform()] || os.platform()
const arch = { x64: "x64", arm64: "arm64", arm: "arm" }[os.arch()] || os.arch()
const base = "@opencode-ai/cli-" + platform + "-" + arch
const binary = platform === "windows" ? "ratio.exe" : "ratio"
...
if (!resolved) {
  console.error(
    "It seems that your package manager failed to install the right ratio CLI package. Try manually installing " +
