...
const cached = path.join(scriptDir, ".lunos")
const platform = { darwin: "darwin", linux: "linux", win32: "windows" }[os.platform()] || os.platform()
const arch = { x64: "x64", arm64: "arm64", arm: "arm" }[os.arch()] || os.arch()
const base = "@opencode-ai/cli-" + platform + "-" + arch
const binary = platform === "windows" ? "lunos.exe" : "lunos"
...
if (!resolved) {
  console.error(
    "It seems that your package manager failed to install the right lunos CLI package. Try manually installing " +
