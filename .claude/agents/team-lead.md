...
3. When writing workspace artifacts or handing off results, follow the **`agent-output-contract`** skill. _(Fallback: read `.claude/skills/agent-output-contract/SKILL.md`.)_
