...
| --------------------------- | -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `deploy.yml`                | Deploys console/web via SST to AWS + Cloudflare.               | Needs Lunos's own AWS account, SST state, and Cloudflare token. References `anomalyco`. **XCOD-17 settled who owns the accounts (Axsion); still open is whether US-controlled providers are acceptable for a hosted offering** — plus XCOD-18 re-pointing. |
