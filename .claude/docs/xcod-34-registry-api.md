...
constraint. This doc captures what Discovery found in the *existing* codebase that XCOD-34's
...
```
  ...
  `searchPlugins`" means reuse the *matching logic*, not the *types* — the registry needs its own
